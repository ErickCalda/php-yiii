...
/**
 * This is the model class for table "cat_tipos_laboratorio".
 *
 * @property int $id
 ...
 */
class CatTiposLaboratorio extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasMany(Laboratorios::class, ['tipo_id' => 'id']);
    }
